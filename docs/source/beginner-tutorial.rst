...
Zipline is an `open-source <https://github.com/stefan-jansen/zipline-crypto>`_ algorithmic trading simulator written in
Python.
...
`zipline/examples <https://github.com/stefan-jansen/zipline-crypto/tree/main/src/zipline/examples>`_ directory,
...
out some of the
`examples <https://github.com/stefan-jansen/zipline-crypto/tree/main/src/zipline/examples>`__.
...
tracker <https://github.com/stefan-jansen/zipline-crypto/issues?state=open>`__,
